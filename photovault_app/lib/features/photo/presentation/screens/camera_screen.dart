...
class _CameraScreenState extends ConsumerState<CameraScreen>
  ...
  Future<void> _capture() async {
    ...
    try {
      ...
      final dest   = p.join(docDir.path, 'photos', '$id.jpg');
        ...
        Positioned(
          ...
          child: Row(
            ...
            children: [
              IconButton(
                icon: const Icon(
                    Icons.photo_library, color: Colors.white, size: 32),
              ...
              IconButton(
                icon: const Icon(
                    Icons.flip_camera_ios, color: Colors.white, size: 32),
