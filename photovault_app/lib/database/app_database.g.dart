...
class $PhotosTable extends Photos with TableInfo<$PhotosTable, Photo> {
  ...
  static const VerificationMeta _audioDescMeta =
      const VerificationMeta('audioDesc');
  @override
  late final GeneratedColumn<String> audioDesc = GeneratedColumn<String>(
      'audio_desc', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  late final GeneratedColumn<String> photographerName = GeneratedColumn<String>(
      'photographer_name', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  Photo map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Photo(
      ...
      audioDesc: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}audio_desc']),
...
class Photo extends DataClass implements Insertable<Photo> {
  ...
  PhotosCompanion toCompanion(bool nullToAbsent) {
    return PhotosCompanion(
      ...
      caption: caption == null && nullToAbsent
          ? const Value.absent()
          : Value(caption),
      audioDesc: audioDesc == null && nullToAbsent
          ? const Value.absent()
          : Value(audioDesc),
      remoteUrl: remoteUrl == null && nullToAbsent
          ? const Value.absent()
          : Value(remoteUrl),
      photographerName: photographerName == null && nullToAbsent
          ? const Value.absent()
  ...
  Photo copyWith(
      ...
      Photo(
        ...
        photographerName: photographerName.present
  ...
  @override
  int get hashCode => Object.hash(id, localPath, createdAt, caption, audioDesc,
      remoteUrl, photographerName, isFavorite);
  @override
...
class $$PhotosTableFilterComposer
  ...
  ColumnFilters<String> get audioDesc => $composableBuilder(
      column: $table.audioDesc, builder: (column) => ColumnFilters(column));
...
class $$PhotosTableOrderingComposer
  ...
  ColumnOrderings<String> get audioDesc => $composableBuilder(
      column: $table.audioDesc, builder: (column) => ColumnOrderings(column));
